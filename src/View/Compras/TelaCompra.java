 ...
 */
public class TelaCompra extends Window {
    ...
    public TelaCompra(GUIScreen gs) {
    ...
    private void init() {
        ...
        botaoIncluir = new Button("Incluir Compra", new Action() {
            @Override
            public void doAction() {
              guitelaVacinas.showWindow(new TelaSelecionaFornecedor(guitelaVacinas));
            }
        });
